...
import { deleteUserProfile, forgotPassword, getUserProfile, handleGoogleCallback, loginUser, registerUser, resetUserPassword, startGoogleLogin, verifyUserPassword } from "../controllers/auth.controller"
